...
namespace Common
{
    ...
    public  class PieGraph
    {
        ...
        public  Bitmap GetPieGraph(string title, int width, int height, int left, int top, DataTable gdt)
        {
        ...
        public void GetLet(int startX, int startY, double dia, double totalAngle, double currentAngle, string leg)
        {
            double x = 0;
            double y = 0;
            double r = dia / 2;
