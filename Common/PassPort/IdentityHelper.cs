...
namespace Common.PassPort
{
    ...
    public class IdentityHelper
    {
        ...
        {
            get { return IsNull ? -1 : Convert.ToInt32(Cookie[UserIdKey]); }
        }
        ...
        {
            get { return IsNull ? null : Convert.ToString(Cookie[UserPhoneKey]); }
        }
        ...
        {
            get { return IsNull ? null : Convert.ToString(Cookie[UserHeadPortraitKey]); }
        }
        ///// <summary>
        ///// 用户类型
        ///// </summary>
        ...
        public static void WriteAdminUser(int UserId, string UserPhone, string UserName, string UserHeadPortrait, Guid token)
        {
            ...
            cookie.Values[UserNameKey] = System.Web.HttpUtility.UrlEncode(UserName);
            cookie.Values[UserIdKey] = System.Web.HttpUtility.UrlEncode(UserId.ToString());
            cookie.Values[UserPhoneKey] = System.Web.HttpUtility.UrlEncode(UserPhone.ToString());
            cookie.Values[UserHeadPortraitKey] = System.Web.HttpUtility.UrlEncode(UserHeadPortrait.ToString());
            //cookie.Values[NikeNameKey] = HttpContext.Current.Server.UrlEncode(nikename);
            cookie.Values[TokenKey] = System.Web.HttpUtility.UrlEncode(token.ToString());
